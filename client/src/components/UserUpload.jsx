...
export default function ResultsPage({ age, categories, onBack }) {
  ...
  return (
    <div>
        <button onClick={onBack} className="mb-6 text-indigo-500 hover:text-indigo-700 font-bold flex items-center gap-2 cursor-pointer bg-white px-4 py-2 rounded-full w-fit shadow-sm">
                ...
                {worksheets.map((sheet, i) => (
                    ...
                    >
                        ...
                        <div className="p-5">
                            ...
                            <a href={sheet.pdfUrl} target="_blank" className="flex items-center justify-center gap-2 w-full bg-indigo-50 text-indigo-600 py-3 rounded-2xl font-bold hover:bg-indigo-600 hover:text-white transition-all cursor-pointer border border-indigo-100 hover:border-indigo-600">
